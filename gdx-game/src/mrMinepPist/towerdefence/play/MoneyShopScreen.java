...
//получить монеты
public class MoneyShopScreen implements Screen {
	BitmapFont font; 
	private Stage stage;
	private SpriteBatch btch;
	public MoneyShopScreen() {
		...
		shopStyle.font = font;
		Label shop = new Label(Property.getDefaultValueString("org.mrMinepPist.towerdefence.translation.Shop.money.name"), shopStyle);
		...
		kStyle.font = font;
		Label slabC = new Label("0.25", kStyle);
		...
		slabM.setSize(16, 16);
		Label slabs = new Label("1 Money", kStyle);
		slabs.setPosition(44, 152);
		slabs.setWrap(true);
		slabs.setSize(72, 72);
		slabs.setFontScale(0.6f);
		Image imlp = new Image(new Texture(pxmls));
		imlp.setSize(80, 96);
		imlp.setPosition(128, 178);
		Image money = new Image(new Texture(Gdx.files.internal("resources/images/blocks/plank.png")));
		money.setPosition(144, 218);
		money.setSize(48, 48);
		Label slabE = new Label("2.80", kStyle);
		slabE.setPosition(136, 184);
		slabE.setSize(40, 40);
		slabE.setFontScale(0.8f);
		Image slabP = new Image(new Texture(Gdx.files.internal("resources/images/gui/coin.jpeg")));
		slabP.setPosition(160, 195);
		slabP.setSize(16, 16);
		Label slabp = new Label("12 Money", kStyle);
		slabp.setPosition(132, 152);
		slabp.setWrap(true);
		slabp.setSize(72, 72);
		slabp.setFontScale(0.6f);
		...
		stage.addActor(slabP);
		stage.addActor(slabE);
		stage.addActor(slabp);
		stage.addActor(iml);
